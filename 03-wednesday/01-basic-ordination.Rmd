...
```{r vare-pca-1, echo=FALSE, fig.width=8, fig.height=8}
...
```{r vare-pca-2, echo=FALSE, fig.width=8, fig.height=8}
pca <- rda(decostand(varespec, method = "hellinger"), scale = TRUE)
biplot(pca, scaling = "symmetric")
```
...
```{r vare-pca-3, fig.width=8, fig.height=6, crop.plot=TRUE}
...
```{r vare-ca-1, echo=FALSE, fig.width=8, fig.height=8, crop.plot=TRUE}
ca <- cca(varespec)
plot(ca)
```
...
```{r ca_biplot, fig.width=8, fig.height=8, crop.plot=TRUE}
